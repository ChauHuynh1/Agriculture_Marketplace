...
public class ForumAdapter extends FirestoreRecyclerAdapter<Forum, ForumAdapter.ForumModelViewHolder> {
    private Context context;

    public ForumAdapter(@NonNull FirestoreRecyclerOptions<Forum> options, Context context) {
        super(options);
    ...
    class ForumModelViewHolder extends RecyclerView.ViewHolder {
        ...
        public ForumModelViewHolder(@NonNull View itemView) {
            ...
            forumpic = itemView.findViewById(R.id.forumImageView);
        }
    }
}